...
EXPERIMENT_NAME="/Users/$DATABRICKS_USERNAME/experiments/agents-on-apps"
...
if EXPERIMENT_RESPONSE=$(databricks experiments create-experiment $EXPERIMENT_NAME 2>/dev/null); then
    ...
    EXPERIMENT_NAME="/Users/$DATABRICKS_USERNAME/experiments/agents-on-apps-$RANDOM_SUFFIX"
